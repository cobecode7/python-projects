...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('apply-coupon').addEventListener('click', function() {
        ...
        if (!couponCode) {
            showCouponMessage('يرجى إدخال كود الكوبون', 'danger');
            return;
        }
        ...
        .then(data => {
            if (data.error) {
                ...
                if (discountType === 'percentage') {
                    discountText = `خصم ${discountValue}%`;
                } else {
                    discountText = `خصم ${discountValue}`;
                }
        ...
        .catch(error => {
            ...
            showCouponMessage('حدث خطأ أثناء تطبيق الكوبون', 'danger');
        });
    });
    ...
    document.getElementById('remove-coupon').addEventListener('click', function() {
        ...
        .then(data => {
            ...
            showCouponMessage('تم إزالة الكوبون', 'info');
        })
        .catch(error => {
            console.error('Error:', error);
            showCouponMessage('حدث خطأ أثناء إزالة الكوبون', 'danger');
        });
    });
});
